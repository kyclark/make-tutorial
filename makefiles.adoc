...
<4> To have `make` use the value of the variable, I deference like `$(VAR)`. Here I show that I can use the environmental variable `$HOME` as the `$(HOME)`.
<5> The `$(INDEX_DIR)` refers to the variable I defined at the top.
